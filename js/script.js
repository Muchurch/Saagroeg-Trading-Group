...
for (let i = 0; i < dropList.length; i++) {
    for(let currency_code in country_list){
        ...
        let selected = i == 0 ? currency_code == "ZAR" ? "selected" : "" : currency_code == "USD" ? "selected" : "";
...
function getExchangeRate(){
    ...
    let url = `https://v6.exchangerate-api.com/v6/49cfc2e93be1a1d5d21947ec/latest/${fromCurrency.value}`;
